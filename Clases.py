...
class Gestor_reserva:
    ...
    def realizar_reserva(self, id_cliente, personas, tipo, fecha_cita, hora_inicio, hora_fin):
        ...
        try:
            ...
            return f"Reserva {id_visual} exitosa. Mesa asignada: {mesa_libre[0].get('id_mesa')} ({tipo})" #Solo se modifico mesa_libre aca
    ...
    def consultar_disponibilidad(self, sesion, fecha_cita=None, hora_inicio=None, hora_fin=None):
        try:
            ...
            # Usamos func.date para comparar solo la FECHA, ignorando la hora del DateTime
